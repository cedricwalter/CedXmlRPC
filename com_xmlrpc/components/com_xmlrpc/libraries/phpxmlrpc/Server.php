...
class Server
{
     ...
     * @param bool|string $doc method documentation
     * @param array|bool $sigDoc the array of valid method signatures docs (one string per param, one for return type)
     */
     ...
     * @return string
     */
    protected function xml_header($charsetEncoding = 'UTF-8')
    {
        if ($charsetEncoding != '') {
